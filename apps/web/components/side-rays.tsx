...
type SideRaysUniforms = {
  ...
  iSpeed: UniformValue
  iRayColor1: UniformValue
  iRayColor2: UniformValue
  iIntensity: UniformValue
  iSpread: UniformValue
  iFlipX: UniformValue
  iFlipY: UniformValue
  iTilt: UniformValue
  iSaturation: UniformValue
  iBlend: UniformValue
  iFalloff: UniformValue
  iOpacity: UniformValue
}
      ...
      cleanupFunctionRef.current = () => {
        ...
        if (renderer) {
          try {
            ...
            // The context may already be gone during route changes.
          }
        }
